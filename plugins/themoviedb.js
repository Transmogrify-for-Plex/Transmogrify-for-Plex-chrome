themoviedb = {
    ...
    getImdbId: function(tmdb_id, callback) {
        var api_url = "https://api.themoviedb.org/3/movie/" + tmdb_id + "?api_key=" + themoviedb.api_key;
    ...
    getTmdbId: function(imdb_id, type, callback) {
        var api_url = "https://api.themoviedb.org/3/find/" + imdb_id + "?external_source=imdb_id&api_key=" + themoviedb.api_key;
    ...
    getMovieCast: function(tmdb_id, callback) {
        var api_url = "https://api.themoviedb.org/3/movie/" + tmdb_id + "/credits?api_key=" + themoviedb.api_key;
    ...
    getActorDetails: function(actor_id, callback){
        var api_url = "https://api.themoviedb.org/3/person/" + actor_id + "?api_key=" + themoviedb.api_key;
